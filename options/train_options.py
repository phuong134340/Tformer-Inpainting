...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--beta1', type=float, default=0.9, help='initial learning rate for adam')
        parser.add_argument('--beta2', type=float, default=0.5, help='initial learning rate for adam')
